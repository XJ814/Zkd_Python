...
# 获取目录下所有的PDF文件
folder_path = r'G:\收文文件\2021\2021.D30.收文\纸质'
...
for pdf_file in pdf_files:
  ...
  try:
    ...
    data.append([file_modified_time,'',int(file_number),document_number,'南阳市总工会', file_name_part,'', num_pages,'']) # 序号从 1 开始
...
# 将数据转换为DataFrame
df = pd.DataFrame(data, columns=['序号','修改时间','档号', '文件号', '文号','责任者', '文件名','日期', '页数','备注'])

# 将DataFrame导出到Excel
excel_path = folder_path + r'\目录.xlsx'  # 您可以修改路径
